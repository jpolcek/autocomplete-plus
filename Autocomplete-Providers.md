...
| [Rust](https://atom.io/package/language-rust)             | `source.rust`     | [racer](https://atom.io/packages/racer)                                 | `racer-racerprovider`            | `1.0.0`               |
| [Typescript](https://atom.io/package/language-typescript) | `source.ts`       | [atom-typescript-tools](https://atom.io/packages/atom-typescript-tools) |                                  | `1.0.0`               |
| [Typescript](https://atom.io/package/language-typescript) | `source.ts`       | [atom-typescript](https://atom.io/packages/atom-typescript)             |                                  | `1.0.0`               |
